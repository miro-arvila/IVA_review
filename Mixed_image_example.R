...
# Load the images
img1 <- load.image("img1.jpg")
img2 <- load.image("img6.jpg")
img3 <- load.image("img7.jpg")
img4 <- load.image("img8.jpg")
img5 <- load.image("img12.jpg")
...
fixedrimg2_G[,,1] <- res_G$S[2,,1]
fixedrimg2_G[,,2] <- res_G$S[2,,2]
fixedrimg2_G[,,3] <- res_G$S[2,,3]

fixedrimg3_G <- imfill(100,100, val=c(1,1,1))
fixedrimg3_G[,,1] <- res_G$S[3,,1]
fixedrimg3_G[,,2] <- res_G$S[3,,2]
fixedrimg3_G[,,3] <- res_G$S[3,,3]

fixedrimg4_G <- imfill(100,100, val=c(1,1,1))
fixedrimg4_G[,,1] <- res_G$S[4,,1]
fixedrimg4_G[,,2] <- res_G$S[4,,2]
fixedrimg4_G[,,3] <- res_G$S[4,,3]

fixedrimg5_G <- imfill(100,100, val=c(1,1,1))
fixedrimg5_G[,,1] <- res_G$S[5,,1]
fixedrimg5_G[,,2] <- res_G$S[5,,2]
